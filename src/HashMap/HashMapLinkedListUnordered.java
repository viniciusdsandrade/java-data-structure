...
Os métodos guardeUmItem e removaUmItem devem se responsabilizar por ajustar o tamanho do vetor conforme as taxas de desperdício descritas acima. Deverá existir ainda um atributo que represente a capacidade inicial com a qual o vetor foi dimensionado. Essa capacidade deve ser fornecida ao construtor para realizar o dimensionamento inicial. Em caso de redimensionamento do vetor para um tamanho menor (decorrente de remoção), deve-se garantir que o tamanho nunca fique abaixo da capacidade inicial.
Obviamente, clonagens devem ser feitas ao armazenar e ao recuperar um valor. Além disso, é natural supor a implementação de todos os métodos obrigatórios.
