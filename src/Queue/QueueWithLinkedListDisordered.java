...
public class QueueWithLinkedListDisordered<X> implements Cloneable {
    ...
    public QueueWithLinkedListDisordered() {
        this.elemento = new LinkedListDisordered<>();
        this.capacidade = 100;
        this.tamanho = 0;
    }
    public QueueWithLinkedListDisordered(int capacidade) {
    ...
    public QueueWithLinkedListDisordered(QueueWithLinkedListDisordered<X> modelo) {
    ...
    @Override
    public Object clone() {
        QueueWithLinkedListDisordered<X> clone = null;
        try {
            clone = new QueueWithLinkedListDisordered<X>(this);
    ...
    public boolean equals(Object obj) {
        ...
        QueueWithLinkedListDisordered<?> queueWithLinkedListDisordered = (QueueWithLinkedListDisordered<?>) obj;

        if (this.tamanho != queueWithLinkedListDisordered.tamanho) return false;
        if (this.capacidade != queueWithLinkedListDisordered.capacidade) return false;

        for (int i = 0; i < this.tamanho; i++) {
            if (!this.elemento.get(i).equals(queueWithLinkedListDisordered.elemento.get(i)))
                return false;
        }
