...
public class TestToString {
    public static void main(String[] args) {
        DoubleLinkedListDisordered<Integer> list_integer = new DoubleLinkedListDisordered<>();
        DoubleLinkedListDisordered<String> list_string = new DoubleLinkedListDisordered<>();
        DoubleLinkedListDisordered<Double> list_double = new DoubleLinkedListDisordered<>();
        DoubleLinkedListDisordered<Character> list_char = new DoubleLinkedListDisordered<>();
        DoubleLinkedListDisordered<Boolean> list_boolean = new DoubleLinkedListDisordered<>();
        DoubleLinkedListDisordered<List<Integer>> list_list_integer = new DoubleLinkedListDisordered<>();
        DoubleLinkedListDisordered<Object> list_object = new DoubleLinkedListDisordered<>();
