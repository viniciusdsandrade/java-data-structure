...
public class TestToString {
    public static void main(String[] args) {
        DoubleLinkedListCircularDisordered<Integer> list_integer = new DoubleLinkedListCircularDisordered<>();
        DoubleLinkedListCircularDisordered<String> list_string = new DoubleLinkedListCircularDisordered<>();
        DoubleLinkedListCircularDisordered<Double> list_double = new DoubleLinkedListCircularDisordered<>();
        DoubleLinkedListCircularDisordered<Character> list_char = new DoubleLinkedListCircularDisordered<>();
        DoubleLinkedListCircularDisordered<Boolean> list_boolean = new DoubleLinkedListCircularDisordered<>();
        DoubleLinkedListCircularDisordered<List<Integer>> list_list_integer = new DoubleLinkedListCircularDisordered<>();
        DoubleLinkedListCircularDisordered<Object> list_object = new DoubleLinkedListCircularDisordered<>();
