 ...
 * add(int index, E element): Adiciona um elemento em uma posição específica da
 * lista.
 * addAll(Collection<? extends E> collection): Adiciona todos os elementos de
 * uma coleção ao final da lista.
 ...
 * descendingIterator(): Retorna um iterador sobre os elementos da lista em
 * ordem descendente.
 ...
 * indexOf(Object element): Retorna o índice da primeira ocorrência do elemento
 * especificado na lista.
 * lastIndexOf(Object element): Retorna o índice da última ocorrência do
 * elemento especificado na lista.
 * listIterator(): Retorna um iterador sobre os elementos da lista (em ordem
 * crescente).
 ...
 * remove(Object element): Remove a primeira ocorrência do elemento especificado
 * da lista, se presente.
 * remove(int index): Remove o elemento na posição especificada na lista.
 * removeFirst(): Remove o primeiro elemento da lista.
 * removeFirstOccurrence(Object element): Remove a primeira ocorrência do
 * elemento especificado da lista, se presente.
 * removeLast(): Remove o último elemento da lista.
 * removeLastOccurrence(Object element): Remove a última ocorrência do elemento
 * especificado da lista, se presente.
 * size(): Retorna o número de elementos na lista.
 * toArray(): Retorna um array contendo todos os elementos da lista.
 * toArray(T[] array): Retorna um array contendo todos os elementos da lista,
...
public class ListaEncadeadaSimplesDesordenada<X> {
    ...
    @SuppressWarnings("unchecked")
    public Object clone() {
        ListaEncadeadaSimplesDesordenada<X> clone;

        try {
            clone = (ListaEncadeadaSimplesDesordenada<X>) super.clone();
    ...
    public int hashCode() {
        ...
        Node aux = head;
        while (aux != null) {
            hash = prime * hash + ((aux.data == null) ? 0 : aux.data.hashCode());
            aux = aux.next;
        }
